            ...
            return o(this, (function(E) {
                switch (E.label) {
                    case 0:
                        ...
                        }, n = window.Blazor._internal.navigationManager.getBaseURI, l = window.Blazor._internal.navigationManager.getLocationHref, window.Blazor._internal.navigationManager.getUnmarshalledBaseURI = function() {
    ...
    var a = n(9),
        i = function() {
            ...
            return e.initAsync = function(t, n) {
                    ...
                    return o(this, (function(o) {
                        switch (o.label) {
                            ...
                            case 3:
                                return o.sent(), [3, 4];
                            case 4:
                                return s ? (c = parseInt(s.headers.get("content-length") || "0"), this.cacheLoads[t] = {
                                    responseBytes: c
                                }, [2, s]) : [3, 5];
                            case 5:
                ...
                // })
                return fetch(
                    Microsoft.Dynamics.NAV.GetImageResource('./src/mydotnetapp/' + t + '.png'), 
                        { 
                            method: "GET", 
                            credentials: "include", 
                            cache: "default"
                ...
                return o(this, (function(r) {
                    switch (r.label) {
                        case 0:
                            ...
                            return [4, fetch(Microsoft.Dynamics.NAV.GetImageResource("./src/mydotnetapp/_framework/blazor.boot.json"), { method: "GET", credentials: "include", cache: "default" })];
                        case 1:
