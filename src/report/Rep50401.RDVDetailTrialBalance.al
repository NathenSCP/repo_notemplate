report 50401 "RDV Detail Trial Balance"
{
    DefaultLayout = RDLC;
    RDLCLayout = './layout-rdlc/Rep50101.RDVDetailTrialBalance.rdlc';
    AdditionalSearchTerms = 'payment due,order status';
    ApplicationArea = Basic, Suite;
    Caption = 'Detail Trial Balance - Burnac';
        ...
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            dataitem(PageCounter; "Integer")
            {
                    ...
                    begin
                        ...
                        case "Source Type" of
                            "Source Type"::Customer:
                                begin
                                    lrecCustomer.Get("Source No.");
                                    SourceName := lrecCustomer.Name;
                                end;
                            "Source Type"::Vendor:
                                begin
                                    lrecVendor.Get("Source No.");
                                    SourceName := lrecVendor.Name;
                                end;
                            "Source Type"::"Bank Account":
                                begin
                                    lrecBankAcct.Get("Source No.");
                                    SourceName := lrecBankAcct.Name;
                                end;
                            "Source Type"::"Fixed Asset":
                                begin
                                    lrecFixedAsset.Get("Source No.");
                                    SourceName := lrecFixedAsset.Description;
                                end;
                            "Source Type"::Employee:
                                begin
                                    lrecEmployee.Get("Source No.");
                                    SourceName := lrecEmployee.FullName;
                                end;
                        end;
                        //nj20210408 - End
                ...
                begin
                    ...
                    PrintOnlyIfDetail_RDV := ExcludeBalanceOnly or (StartBalance = 0);  //nj20210408
                end;
                //PageCounter - End
            }
            ...
            begin
                ...
                if PrintOnlyOnePerPage then begin
                    ...
                    if PrintOnlyIfDetail_RDV and GLEntry.FindFirst then   //nj20210408
